...
REM BOLLETTA
REM set "url1=https://cruscottodb.evaenergyservice.it/public/question/71833775-044d-49f7-aaa2-e9b48e29e081.csv"
REM set "bolletta=bolletta_%data%.csv"

REM SWITCH OUT
set "url2=https://cruscottodb.evaenergyservice.it/public/question/15b86c29-6978-4882-8660-973d6e8dd556.csv"
...
REM set "url3=https://cruscottodb.evaenergyservice.it/public/question/d76d76ff-b202-4466-a035-fd9368fa2efa.csv"
...
set "logFile=C:\VOC_2.0\log\MENSILE-log-%data%.log"
...
if %step1% equ 0 (
	if %step2% equ 0 (
		%blat% -to "%recipient%" -cc %copiaconoscenza% -subject "Upload Mensile SANDSIV OK" -html -body "Ciao,<br /><br />Il caricamento dei files <b><i>e' avvenuto correttamente</i></b>.<br /><br />I seguenti files sono stati caricati:<br />- %bolletta% <br />- %switchout% <br />- %welcomeletter% <br /><br />Il Team IT Eva Solutions"
	) else (
	%blat% -to "%recipient%" -cc %copiaconoscenza% -subject "Errore upload Mensile SANDSIV" -html -body "Ciao,<br /><br />Il caricamento dei files <b><i>NON e' avvenuto correttamente</i></b>.<br /><br />Procedere con il caricamento manuale.<br /><br />APRI UNA SEGNALAZIONE A sistemi@evaenergyservice.it.<br /><br />Distinti Saluti.<br /><br />Il Team IT Eva Solutions"
	)
) else (
	%blat% -to "%recipient%" -cc %copiaconoscenza% -subject "Errore upload Mensile SFTP SANDSIV" -html -body "Ciao,<br /><br />Il caricamento dei files <b><i>NON e' avvenuto correttamente</i></b>.<br /><br />APRI UNA SEGNALAZIONE A sistemi@evaenergyservice.it.<br /><br />Il Team IT Eva Solutions"
)
